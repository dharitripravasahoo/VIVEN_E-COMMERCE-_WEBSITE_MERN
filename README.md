...
MONGO_URI=mongodb://127.0.0.1:27017/VIVEN
JWT_SECRET=super_secret_key
RAZORPAY_KEY_ID=your_key_id
RAZORPAY_KEY_SECRET=your_key_secret
```

From the **root folder** `VIVEN/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@VIVEN.com` | Password: `password123`
...
This repository includes a fully-scaffolded API testing toolkit: **`VIVEN_Postman_Collection.json`**. 
